...
from lythea.cognition.auto_calibrator import (
...
def test_format_warning_basic():
    from lythea.cognition.warnings_v4 import format_warning
    out = format_warning(
...
def test_is_v4_warning_line_detection():
    from lythea.cognition.warnings_v4 import is_v4_warning_line
