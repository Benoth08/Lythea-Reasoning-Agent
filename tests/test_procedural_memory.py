...
class TestSanitization:
    ...
    def test_sanitize_strips_whitespace(self):
        from lythea.memory.procedural import _sanitize_field
...
class TestForbidden:
    ...
    def test_forbidden_mentir(self):
        from lythea.memory.procedural import _is_forbidden
...
class TestUtilityScore:
    ...
    def test_high_confidence_high_use(self):
        from lythea.memory.procedural import Procedure
        p = Procedure(
...
class TestExtraction:
    ...
    def test_extract_valid_json(self):
        from lythea.memory.procedural import extract_procedures_from_conversation
...
class TestRenderPlaybook:
    ...
    def test_render_basic(self):
        from lythea.memory.procedural import render_playbook, Procedure
        procs = [
