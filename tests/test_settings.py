...
def test_validation_rejects_out_of_range():
    ...
    from lythea.settings import LytheaSettings, get_settings
...
def test_config_module_reexports():
    """Backward compatibility: ``from lythea.config import X`` must work."""
    # Cleanup first
    get_settings_clear()

    from lythea import config
...
def get_settings_clear():
    ...
    """
    import importlib
    from lythea import settings as settings_mod
