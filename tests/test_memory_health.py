...
class TestFreshness:
    ...
    def test_empty_chroma(self):
        from lythea.memory.health import _compute_freshness
...
class TestCoverage:
    ...
    def test_empty(self):
        from lythea.memory.health import _compute_coverage
...
class TestCoherence:
    ...
    def test_no_communities(self):
        from lythea.memory.health import _compute_coherence
        kg = FakeKG()
...
class TestEfficiency:
    ...
    def test_no_kg(self):
        from lythea.memory.health import _compute_efficiency
...
class TestReachability:
    ...
    def test_too_few_entities(self):
        from lythea.memory.health import _compute_reachability
        kg = FakeKG(entities={"e1": FakeEnt("e1")})
...
class TestHintForScore:
    ...
    def test_high_score(self):
        from lythea.memory.health import _hint_for_score
