...
def test_every_catalog_entry_has_a_profile_or_defaults():
    ...
    from lythea.config import CATALOG, SamplingProfile
...
def test_get_sampling_returns_profile_fields():
    ...
    from lythea.config import SamplingProfile
    from lythea.server.routes import get_sampling
...
def test_post_sampling_partial_update():
    ...
    from lythea.config import SamplingProfile
    from lythea.server.routes import config_sampling
    from lythea.server.schemas import SamplingConfigRequest
