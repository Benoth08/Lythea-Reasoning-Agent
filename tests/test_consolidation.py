...
from lythea.cognition.consolidation import ConsolidationPhase  # noqa: E402
...
def test_maybe_trigger_at_interval():
    ...
    from lythea.config import MICROSLEEP_INTERVAL
    phase, _ = _make_phase()
    triggered = []
...
def test_run_microsleep_calls_consolidate_with_settings():
    from lythea.config import MICROSLEEP_BOOST, MICROSLEEP_REHEARSE_K
    phase, m = _make_phase()
    phase._run_microsleep()
