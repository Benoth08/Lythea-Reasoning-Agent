...
class FakeEncodingPhase:
    ...
    def __new__(cls, gliner=None):
        from lythea.cognition.encoding import EncodingPhase
...
class TestSelfRoleRegex:
    ...
    def test_single_word_role(self):
        from lythea.cognition.encoding import _SELF_ROLE_RE
...
class TestSelfLocationRegex:
    ...
    def test_jhabite_simple(self):
        from lythea.cognition.encoding import _SELF_LOCATION_RE
...
class TestSelfEmployerRegex:
    ...
    def test_je_travaille_chez(self):
        from lythea.cognition.encoding import _SELF_EMPLOYER_RE
...
class TestSelfAgeRegex:
    ...
    def test_jai_n_ans(self):
        from lythea.cognition.encoding import _SELF_AGE_RE
