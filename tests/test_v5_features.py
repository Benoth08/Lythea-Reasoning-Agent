...
class TestWebClassifierV5:
    ...
    def test_looks_like_question_positive(self):
        from lythea.cognition.web_classifier import looks_like_question
        for msg in [
    ...
    def test_parse_classifier_response(self):
        from lythea.cognition.web_classifier import _parse_classifier_response
        cases = [
...
class TestWebTagsV5:
    ...
    def test_web_tag_forces_search(self):
        from lythea.web import WebTriggerPolicy
...
class TestSemanticRouterStructure:
    ...
    def test_routes_defined(self):
        from lythea.cognition.semantic_router import ROUTES
...
class TestToolDispatcherV51:
    ...
    def test_parse_strict_json(self):
        from lythea.cognition.tool_dispatcher import _parse_dispatcher_response
    ...
    def test_dispatch_cache(self):
        from lythea.cognition.tool_dispatcher import (
...
class TestPythonExecutorV51:
    ...
    def test_simple_calc(self):
        from lythea.tools.python_executor import run
    ...
    def test_format_result(self):
        from lythea.tools.python_executor import run, format_result
...
class TestCRAGEvaluate:
    ...
    def test_empty(self):
        from lythea.cognition.crag import evaluate_retrieval, RetrievalStatus
...
class TestCRAGRescue:
    ...
    def test_no_rescue_if_correct(self):
        from lythea.cognition.crag import evaluate_and_rescue
    ...
    def test_rescue_succeeds(self):
        from lythea.cognition.crag import evaluate_and_rescue, RetrievalStatus
    ...
    def test_cognitive_items(self):
        from lythea.cognition.crag import (
...
class TestGraphCommunitiesDetection:
    ...
    def test_empty_kg(self):
        from lythea.cognition.graph_communities import detect_communities
...
class TestGraphCommunitiesSummarise:
    ...
    def test_summarise_basic(self):
        from lythea.cognition.graph_communities import (
...
class TestGraphCommunitiesRender:
    ...
    def test_render_empty(self):
        from lythea.cognition.graph_communities import render_community_context
...
def reset_caches():
    yield
    try:
        from lythea.cognition.web_classifier import clear_cache as wc
        wc()
    except Exception:
        pass
    try:
        from lythea.cognition.tool_dispatcher import clear_cache as tc
        tc()
    except Exception:
        pass
