...
from lythea.web_providers import (
    get_default_provider,
    get_provider,
    list_providers,
)
from lythea.web_providers.base import WebSearchProvider
from lythea.web_providers.ddg import DdgProvider
from lythea.web_providers.factory import CompositeProvider
from lythea.web_providers.searxng import SearxngProvider
...
def test_webagent_uses_injected_provider():
    ...
    from lythea.web import WebAgent
...
def test_brave_unavailable_without_key(monkeypatch):
    from lythea.web_providers.brave import BraveProvider
...
def test_tavily_unavailable_without_key(monkeypatch):
    from lythea.web_providers.tavily import TavilyProvider
...
def test_serper_unavailable_without_key(monkeypatch):
    from lythea.web_providers.serper import SerperProvider
...
def test_chain_skips_unavailable_providers(monkeypatch):
    ...
    from lythea.web_providers.factory import (
...
def test_registry_lists_all_5_providers():
    from lythea.web_providers.factory import list_providers
