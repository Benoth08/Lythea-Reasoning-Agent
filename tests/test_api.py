...
def test_schemas_validation():
    ...
    from lythea.server.schemas import ChatRequest, ImageInput, SessionPatch
...
def test_schemas_reject_extra():
    ...
    from lythea.server.schemas import ChatRequest
    import pydantic
...
def test_schemas_max_images():
    ...
    from lythea.server.schemas import ChatRequest, ImageInput
    import pydantic
...
def test_session_manager_crud():
    ...
    from lythea.sessions import SessionManager, Message
