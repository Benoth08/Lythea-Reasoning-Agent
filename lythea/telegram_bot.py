"""Passerelle Telegram pour Lythéa — parle à Taëlys depuis ton téléphone.
...
class TelegramBot(threading.Thread):
    ...
    def _handle_text(self, chat_id: int, text: str) -> None:
        ...
        if text.startswith("/start") or text.startswith("/aide"):
            self._send(chat_id,
                       "Taëlys en ligne. Envoie-moi du texte (pipeline cognitif "
...
def main() -> None:
    ...
    from lythea.boot import BootRunner, BootState
