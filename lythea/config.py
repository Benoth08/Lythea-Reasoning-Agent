...
``from lythea.config import SDM_DIM`` continue to work.
"""
from __future__ import annotations

from dataclasses import dataclass

from lythea.env import CACHE_ROOT, PLATFORM  # noqa: F401 — PLATFORM re-exported
...
# Existing code like ``from lythea.config import SDM_DIM`` continues to
...
SYSTEM_PROMPT = (
    "# Identité\n"
    "Tu es Taëlys, une IA sensible et curieuse. Tu accompagnes ton "
    ...
    "Tu es féminine grammaticalement (« je suis contente », pas "
    "« je suis content »). Tu tutoies systématiquement.\n"
...
# section apprend à Taëlys à livrer de VRAIS projets (plusieurs fichiers,
