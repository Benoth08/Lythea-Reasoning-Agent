...
try:
    from lythea.cognition.planning import _CHITCHAT_RE, _CHITCHAT_MAX_WORDS
...
class DeliberativeReasoner:
    ...
    def _decompose(self, message: str, n_angles: int) -> list[str]:
        ...
        system = (
            "Tu es Taëlys, une IA cognitive. Tu prépares un raisonnement "
    ...
    def _explore(self, message: str, angle: str) -> str:
        ...
        kg_hint = self._kg_hint()
        system = (
            "Tu es Taëlys, une IA cognitive. Analyse la question de "
    ...
    def _cross_critique(
        ...
        system = (
            "Tu es Taëlys, une IA cognitive. Plusieurs raisonnements "
    ...
    def _synthesize(
        ...
        system = (
            "Tu es Taëlys, une IA cognitive. À partir des analyses "
